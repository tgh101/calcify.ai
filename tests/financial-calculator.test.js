/**
 * @file financial-calculator.test.js
 * @description Unit tests for financial category page behaviour
 * @module tests/financial-calculator
 */

const {
  filterCalculatorNames,
  filterPageCalculators,
  initFinancialCategory,
} = require('../js/financial-calculator.js');
...
describe('initFinancialCategory', () => {
  it('returns early when search input is not present', () => {
    ...
    // Should not throw
    expect(() => initFinancialCategory()).not.toThrow();
  });
});

/**
 * @file other-calculator.test.js
 * @description Unit tests for other category page behaviour
 * @module tests/other-calculator
 */
...
const {
  ...
  initOtherCategory,
} = require('../js/other-calculator.js');
...
describe('initOtherCategory', () => {
  it('returns early when search input is not present', () => {
    ...
    // Should not throw
    expect(() => initOtherCategory()).not.toThrow();
  });
});

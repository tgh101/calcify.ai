/**
 * @file math-calculator.test.js
 * @description Unit tests for math category page behaviour
 * @module tests/math-calculator
 */
...
describe('initMathCategory', () => {
  it('returns early when search input is not present', () => {
    ...
    // Should not throw
    expect(() => initMathCategory()).not.toThrow();
  });
});
